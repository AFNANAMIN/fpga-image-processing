...
xst -ifn xst.scr
move cmt5_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\cmt5_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc cmt5_exdes.ucf cmt5_exdes

echo 'Running map'
map -timing -pr b cmt5_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm cmt5_exdes -w routed.ncd routed.v
cd ..
