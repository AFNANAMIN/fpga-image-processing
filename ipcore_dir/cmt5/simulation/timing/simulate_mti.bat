...
vlog -work work cmt5_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax cmt5_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.cmt5_tb work.glbl
